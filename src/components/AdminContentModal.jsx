...
const AdminBannerContent = React.lazy(() => import('./AdminBannerContent'));
import { useSettingsStore } from '../store/settingsStore';
import { useUIStore } from '../store/uiStore';

export default function AdminContentModal({ isOpen, onClose, isEmbedded = false }) {
    ...
    // Inner content
    const Content = (
        <div className={`bg-white rounded-2xl flex flex-col shadow-2xl overflow-hidden ${isEmbedded ? 'w-full h-full' : 'w-full max-w-4xl max-h-[90vh]'}`}>
            {/* Header */}
