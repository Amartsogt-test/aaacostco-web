...
export default function AdminBannerModal({ isOpen, onClose, isEmbedded = false }) {
    ...
    // Inner content
    const Content = (
        <div className={`bg-white rounded-3xl shadow-2xl overflow-hidden animate-scale-in ${isEmbedded ? 'w-full' : 'w-full max-w-2xl'}`}>
            ...
            <div className="p-6 border-t bg-gray-50 flex gap-3">
                ...
                <button
                    ...
                    className={`${isEmbedded ? 'w-full' : 'flex-[2]'} py-3 px-4 bg-costco-blue text-white rounded-xl font-bold flex items-center justify-center gap-2 shadow-lg shadow-blue-100 transition ${isSaving || isUploading ? 'opacity-50' : 'hover:bg-blue-700'}`}
                >
